...
$extendJson = json_decode(file_get_contents('extend.json', 'r'), true);

define('SERVER_AUTHORIZATION', $extendJson['SERVER_AUTHORIZATION']); // 后端授权

define('AAPT_PATH', $extendJson['AAPT_PATH']); // aapt执行文件的路径
?>