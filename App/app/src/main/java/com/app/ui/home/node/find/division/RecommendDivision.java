...
import com.app.ui.recommend.RecommendActivity;

import org.jetbrains.annotations.NotNull;

public class RecommendDivision extends DistributeLifecycleEventObserver {

    private ViewGroup RankingButton;

    private FindFragment fragment;

    public RecommendDivision(ViewGroup RankingButton) {
    ...
    private void initView() {
        RankingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                fragment.startActivity(new Intent(fragment.getContext(), RecommendActivity.class));
            }
        });
    }
